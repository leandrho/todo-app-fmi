    ...
    <form action="#" className="h-16 flex">
      <div className="bg-white rounded-lg flex-grow flex items-center gap-6 px-4">
        <button aria-label="submit" 
                className="appearance-none min-w-[28px] min-h-[28px] cursor-pointer rounded-full border-2 border-[--border-check] hover:bg-gradient-to-br hover:from-[--grad-from] hover:to-[--grad-to]"
